...
public class Tutorial_Step2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial__step2);
        ...
        go_button.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToTab = new Intent(Tutorial_Step2.this, Analysis_results.class);
        ...
        ImageButton home = findViewById(R.id.home5);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent goToTab = new Intent(Tutorial_Step2.this, Menu.class);
                startActivity(goToTab);
